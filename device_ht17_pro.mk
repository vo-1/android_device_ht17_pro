...
$(call inherit-product-if-exists, vendor/homtom/ht17_pro/ht17_pro-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/homtom/ht17_pro/overlay
...
ifeq ($(TARGET_PREBUILT_KERNEL),)
    LOCAL_KERNEL := device/homtom/ht17_pro/prebuilt/Image.gz-dtb
else
    LOCAL_KERNEL := $(TARGET_PREBUILT_KERNEL)
endif

#TARGET_OTA_ASSERT_DEVICE := ht17_pro

TARGET_PROVIDES_INIT_RC := true

PRODUCT_COPY_FILES += \
    device/homtom/ht17_pro/rootdir/init.rc:root/init.rc \
    device/homtom/ht17_pro/rootdir/init.target.rc:root/init.target.rc \
    device/homtom/ht17_pro/rootdir/init.mt6735.rc:root/init.mt6735.rc \
    device/homtom/ht17_pro/rootdir/init.ssd.rc:root/init.ssd.rc \
    device/homtom/ht17_pro/rootdir/init.xlog.rc:root/init.xlog.rc \
    device/homtom/ht17_pro/rootdir/init.usb.rc:root/init.usb.rc \
    device/homtom/ht17_pro/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
    device/homtom/ht17_pro/rootdir/init.aee.rc:root/init.aee.rc \
    device/homtom/ht17_pro/rootdir/init.project.rc:root/init.project.rc \
    device/homtom/ht17_pro/rootdir/init.modem.rc:root/init.modem.rc \
    device/homtom/ht17_pro/rootdir/init.trace.rc:root/init.trace.rc \
    device/homtom/ht17_pro/rootdir/fstab.mt6735:root/fstab.mt6735 \
    device/homtom/ht17_pro/rootdir/fstab.swap:root/fstab.swap \
    device/homtom/ht17_pro/rootdir/ueventd.rc:root/ueventd.rc \
    device/homtom/ht17_pro/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/homtom/ht17_pro/etc/init/audioserver.rc:system/etc/init/audioserver.rc \
    device/homtom/ht17_pro/etc/init/mediacodec.rc:system/etc/init/mediacodec.rc \
    device/homtom/ht17_pro/etc/init/cameraserver.rc:system/etc/init/cameraserver.rc \
    device/homtom/ht17_pro/etc/init/rild.rc:system/etc/init/rild.rc \
    device/homtom/ht17_pro/media_profiles.xml:system/etc/media_profiles.xml \
...
PRODUCT_COPY_FILES += \
    device/homtom/ht17_pro/rootdir/etc/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf \
...
# BT A2DP
# PRODUCT_COPY_FILES += \
#    vendor/homtom/ht17_pro/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so
...
#PRODUCT_EXTRA_RECOVERY_KEYS += device/homtom/ht17_pro/homtom

$(call inherit-product, $(SRC_TARGET_DIR)/product/core_64_bit.mk)
$(call inherit-product, $(SRC_TARGET_DIR)/product/full_base_telephony.mk)
#$(call inherit-product, build/target/product/aosp_arm64.mk)

#PRODUCT_NAME := cm_ht17_pro
#PRODUCT_DEVICE := ht17_pro
#PRODUCT_BRAND := CyaniogenMod
#PRODUCT_MODEL := CyaniogenMod on homtom ht17_pro
...
#persist.sys.homtom.region=cn \
#persist.sys.homtom.codepage=gbk \
#ro.homtom.setupwizard.flyme=true \
#ro.homtom.setupwizard.setlang=true \
#ro.homtom.region.enable=true \
#ro.homtom.contactmsg.auth=false \
#ro.homtom.customize.pccw=false \
#ro.homtom.autorecorder=true \
#ro.homtom.visualvoicemail=true \
#ro.homtom.security=false \
#ro.homtom.permanentkey=false \
#ro.homtom.sip.support=true \
#ro.homtom.voip.support=false \
#sys.homtom.m35x.white.config=false \
#sys.homtom.white.config=false \
